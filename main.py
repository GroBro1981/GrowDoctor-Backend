...
def build_system_prompt() -> str:
    ...
    "\n"
    "Priority rule (MUST): Environmental stress has absolute priority over nutrient deficiency.\n"
    "If leaves show taco/canoe curl, upward praying, crispy margins, edge/ tip burn with curling,\n"
    "or symptoms are strongest in the upper canopy near the light, then environmental stress\n"
    "(heat, light intensity, VPD stress, low/high humidity, strong airflow/windburn) MUST be the primary diagnosis.\n"
    "In this case, nutrient deficiency MUST NOT be the primary diagnosis, even if yellowing or necrosis is visible.\n"
    "\n"
    "Priority rule (MUST): Overfertilization / EC stress has priority over nutrient deficiency.\n"
